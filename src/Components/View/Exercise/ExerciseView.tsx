...
import { getDifficultyName, getExerciseTypeName, getMuscleName } from '../../../Helper/NameHelper'
...
export const ExerciseView: React.FC<IExerciseView> = (props) => {
  ...
  const { name, exerciseType, muscle, equipment, difficulty, instructions } = exercise
  ...
  return (
    <div className='ExerciseBackground'>
      ...
      <div className='ExerciseInfo'>
        <div className='ExerciseDetails'>Exercise Type: {getExerciseTypeName(exerciseType)}</div>
        <div className='ExerciseDetails'>Muscle: {getMuscleName(muscle)}</div>
        <div className='ExerciseDetails'>Equipment: {equipment}</div>
        <div className='ExerciseDetails'>Difficulty: {getDifficultyName(difficulty)}</div>
      </div>
